...
const NhanVien = () => {
  ...
  const getNhanVien = async () => {
    ...
    const activeNhanVienData = loadTable.filter(
        ...
        <Table
          ...
          columns={[
            ...
            },
            {
              ...
              key: "NGAYSINH",
              render: (text) =>
                text ? moment(text).format("DD/MM/YYYY") : "Chưa có",
            },
            {
              title: "ẢNH",
              dataIndex: "ANH",
