...
const ChatLieu = () => {
    ...
    const filteredChatLieu = chatLieu.filter(item => item.TEN.toLowerCase().includes(searchTerm.toLowerCase()));
    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center' }}>
            <div style={{ width: '100%', marginLeft: '350px' }}>
                ...
                <Input
                    placeholder='Nhập tên chất liệu để thêm'
                    value={ten}
                ...
                <Table
                    ...
                    dataSource={filteredChatLieu} // Sử dụng dữ liệu đã lọc
                />
            </div>
